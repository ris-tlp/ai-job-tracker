...
class ParsedImageRepository:
    ...
    async def create_parsed_image(self, image_name: str, parsed_text: str) -> ParsedImageDTO:
...
async def get_parsed_image_repository(session: AsyncSession = Depends(get_session)) -> ParsedImageRepository:
