...
const Hero: React.FC = () => (
  <Element name="hero" className="relative flex flex-col justify-center items-center text-center px-6 bg-gradient-to-br from-[var(--color-bg)] via-white to-[var(--color-surface)] overflow-hidden h-screen">
    ...
    <div className="flex flex-col md:flex-row gap-4 justify-center">
      ...
      <a href="https://github.com/ris-tlp/job-portal" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center gap-2 bg-white border border-[var(--color-primary)] hover:border-[var(--color-secondary)] text-[var(--color-primary)] font-bold px-8 py-4 rounded-full shadow text-lg hover:bg-[var(--color-secondary)] hover:text-white transition-colors duration-200">
