  ...
  <Element name="testimonial" className="py-20 px-4 bg-white flex flex-col items-center">
    <div className="max-w-2xl mx-auto text-center">
      <div className="flex flex-col items-center mb-6">
        <img src="https://randomuser.me/api/portraits/men/32.jpg" alt="Testimonial" className="w-16 h-16 rounded-full border-4 border-[var(--color-primary)] shadow mb-2" />
        <span className="text-lg font-bold text-[var(--color-primary)]">Alex Q., Software Lead</span>
      </div>
